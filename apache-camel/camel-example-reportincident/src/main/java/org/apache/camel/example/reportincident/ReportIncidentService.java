 ...
 * 2017-03-26T14:05:55.536-05:00
 * Generated source version: 2.6.1
 * 
 */
@WebServiceClient(name = "ReportIncidentService", 
                  wsdlLocation = "file:/E:/jacksondat/workspace/training/apache-camel/camel-example-reportincident/src/main/webapp/WEB-INF/wsdl/report_incident.wsdl",
...
public class ReportIncidentService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/jacksondat/workspace/training/apache-camel/camel-example-reportincident/src/main/webapp/WEB-INF/wsdl/report_incident.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ReportIncidentService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/E:/jacksondat/workspace/training/apache-camel/camel-example-reportincident/src/main/webapp/WEB-INF/wsdl/report_incident.wsdl");
        }
        WSDL_LOCATION = url;
    }
